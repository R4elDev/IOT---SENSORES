...
# A resolução padrão é de 10 bits (0-1023), mas vamos usar 12 bits para maior precisão (0-4095).
...
while True:
    ...
    # Solo seco: 0 (vou próximo disso)
    # Solo úmido: 4095 (ou próximo disso)
    # Use um valor limite (por exemplo, 2000) com base nos seus testes.
    LIMIAR_SECO = 2000
